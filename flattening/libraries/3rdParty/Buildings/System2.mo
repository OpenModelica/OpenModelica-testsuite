...
//   Real rad.port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if rad.allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real rad.port_b.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if rad.allowFlowReversal then 1e+060 else 0.0);
...
//   Real sin.ports[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if sin.flowDirection == Modelica.Fluid.Types.PortFlowDirection.Entering then 0.0 else -1e+060, max = if sin.flowDirection == Modelica.Fluid.Types.PortFlowDirection.Leaving then 0.0 else 1e+060);
...
//   Real temSup.port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if temSup.allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real temSup.port_b.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if temSup.allowFlowReversal then 1e+060 else 0.0);
...
//   protected final parameter Boolean temSup.dynamic = temSup.tau > 1e-010 or temSup.tau < -1e-010;
...
//   Real pumRad.port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if pumRad.allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real pumRad.port_b.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if pumRad.allowFlowReversal then 1e+060 else 0.0);
...
//   protected Real pumRad.preSou.port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if pumRad.preSou.allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   protected Real pumRad.preSou.port_b.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if pumRad.preSou.allowFlowReversal then 1e+060 else 0.0);
...
//   protected Real pumRad.preSou.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if pumRad.preSou.allowFlowReversal then -1e+060 else 0.0, max = 100000.0, start = pumRad.preSou.m_flow_start);
...
//   Real sou.ports[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if sou.flowDirection == Modelica.Fluid.Types.PortFlowDirection.Entering then 0.0 else -1e+060, max = if sou.flowDirection == Modelica.Fluid.Types.PortFlowDirection.Leaving then 0.0 else 1e+060);
...
//   vol.dynBal.medium.X_sat = min(vol.dynBal.medium.p_steam_sat * steam.MM * (1.0 - vol.dynBal.medium.Xi[1]) / (dryair.MM * max(1e-013, vol.dynBal.medium.p - vol.dynBal.medium.p_steam_sat)), 1.0);
...
//   vol.dynBal.medium.x_sat = steam.MM * vol.dynBal.medium.p_steam_sat / (dryair.MM * max(1e-013, vol.dynBal.medium.p - vol.dynBal.medium.p_steam_sat));
//   vol.dynBal.medium.x_water = vol.dynBal.medium.Xi[1] / max(vol.dynBal.medium.X_air, 1e-013);
