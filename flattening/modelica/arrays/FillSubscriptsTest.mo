...
//   Real sin_1.ports[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if sin_1.flowDirection == Modelica.Fluid.Types.PortFlowDirection.Entering then 0.0 else -1e+060, max = if sin_1.flowDirection == Modelica.Fluid.Types.PortFlowDirection.Leaving then 0.0 else 1e+060);
...
//   Real res_1.port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if res_1.allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real res_1.port_b.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if res_1.allowFlowReversal then 1e+060 else 0.0);
...
//   protected final parameter Boolean res_1.computeFlowResistance = res_1.dp_nominal_pos > 1e-015;
//   parameter Boolean mfr_1[1].allowFlowReversal = system.allowFlowReversal;
//   Real mfr_1[1].port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if mfr_1[1].allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real mfr_1[1].port_b.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if mfr_1[1].allowFlowReversal then 1e+060 else 0.0);
...
//   Real mfr_1[2].port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if mfr_1[2].allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real mfr_1[2].port_b.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if mfr_1[2].allowFlowReversal then 1e+060 else 0.0);
...
//   Real mfr_1[3].port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if mfr_1[3].allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real mfr_1[3].port_b.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if mfr_1[3].allowFlowReversal then 1e+060 else 0.0);
...
//   Real pipFixRes_1.port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if pipFixRes_1.allowFlowReversal then -1e+060 else 0.0, max = 100000.0, start = pipFixRes_1.mStart_flow_a);
...
//   Real pipFixRes_1.port_b[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if pipFixRes_1.allowFlowReversal then 1e+060 else 0.0, start = (-pipFixRes_1.mStart_flow_a) / /*Real*/(pipFixRes_1.nPipPar));
...
//   Real pipFixRes_1.port_b[2].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if pipFixRes_1.allowFlowReversal then 1e+060 else 0.0, start = (-pipFixRes_1.mStart_flow_a) / /*Real*/(pipFixRes_1.nPipPar));
...
//   Real pipFixRes_1.port_b[3].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if pipFixRes_1.allowFlowReversal then 1e+060 else 0.0, start = (-pipFixRes_1.mStart_flow_a) / /*Real*/(pipFixRes_1.nPipPar));
...
//   Real pipFixRes_1.fixRes.port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if pipFixRes_1.fixRes.allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real pipFixRes_1.fixRes.port_b.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if pipFixRes_1.fixRes.allowFlowReversal then 1e+060 else 0.0);
...
//   protected final parameter Boolean pipFixRes_1.fixRes.computeFlowResistance = pipFixRes_1.fixRes.dp_nominal_pos > 1e-015;
...
//   protected Real pipFixRes_1.floDis.port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if pipFixRes_1.floDis.allowFlowReversal then -1e+060 else 0.0, max = 100000.0, start = pipFixRes_1.floDis.mStart_flow_a);
...
//   protected Real pipFixRes_1.floDis.port_b[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if pipFixRes_1.floDis.allowFlowReversal then 1e+060 else 0.0, start = (-pipFixRes_1.floDis.mStart_flow_a) / /*Real*/(pipFixRes_1.floDis.nPipPar));
...
//   protected Real pipFixRes_1.floDis.port_b[2].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if pipFixRes_1.floDis.allowFlowReversal then 1e+060 else 0.0, start = (-pipFixRes_1.floDis.mStart_flow_a) / /*Real*/(pipFixRes_1.floDis.nPipPar));
...
//   protected Real pipFixRes_1.floDis.port_b[3].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if pipFixRes_1.floDis.allowFlowReversal then 1e+060 else 0.0, start = (-pipFixRes_1.floDis.mStart_flow_a) / /*Real*/(pipFixRes_1.floDis.nPipPar));
...
//   Real pipNoRes_1.port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if pipNoRes_1.allowFlowReversal then -1e+060 else 0.0, max = 100000.0, start = pipNoRes_1.mStart_flow_a);
...
//   Real pipNoRes_1.port_b[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if pipNoRes_1.allowFlowReversal then 1e+060 else 0.0, start = (-pipNoRes_1.mStart_flow_a) / /*Real*/(pipNoRes_1.nPipPar));
...
//   Real pipNoRes_1.port_b[2].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if pipNoRes_1.allowFlowReversal then 1e+060 else 0.0, start = (-pipNoRes_1.mStart_flow_a) / /*Real*/(pipNoRes_1.nPipPar));
...
//   Real pipNoRes_1.port_b[3].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if pipNoRes_1.allowFlowReversal then 1e+060 else 0.0, start = (-pipNoRes_1.mStart_flow_a) / /*Real*/(pipNoRes_1.nPipPar));
...
//   Real res_2.port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if res_2.allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real res_2.port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if res_2.allowFlowReversal then 1e+060 else 0.0);
...
//   protected final parameter Boolean res_2.computeFlowResistance = res_2.dp_nominal_pos > 1e-015;
//   parameter Boolean mfr_2[1,1].allowFlowReversal = system.allowFlowReversal;
//   Real mfr_2[1,1].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[1,1].allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real mfr_2[1,1].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if mfr_2[1,1].allowFlowReversal then 1e+060 else 0.0);
...
//   Real mfr_2[1,2].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[1,2].allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real mfr_2[1,2].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if mfr_2[1,2].allowFlowReversal then 1e+060 else 0.0);
...
//   Real mfr_2[1,3].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[1,3].allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real mfr_2[1,3].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if mfr_2[1,3].allowFlowReversal then 1e+060 else 0.0);
...
//   Real mfr_2[1,4].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[1,4].allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real mfr_2[1,4].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if mfr_2[1,4].allowFlowReversal then 1e+060 else 0.0);
...
//   Real mfr_2[2,1].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[2,1].allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real mfr_2[2,1].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if mfr_2[2,1].allowFlowReversal then 1e+060 else 0.0);
...
//   Real mfr_2[2,2].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[2,2].allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real mfr_2[2,2].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if mfr_2[2,2].allowFlowReversal then 1e+060 else 0.0);
...
//   Real mfr_2[2,3].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[2,3].allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real mfr_2[2,3].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if mfr_2[2,3].allowFlowReversal then 1e+060 else 0.0);
...
//   Real mfr_2[2,4].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[2,4].allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real mfr_2[2,4].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if mfr_2[2,4].allowFlowReversal then 1e+060 else 0.0);
...
//   Real mfr_2[3,1].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[3,1].allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real mfr_2[3,1].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if mfr_2[3,1].allowFlowReversal then 1e+060 else 0.0);
...
//   Real mfr_2[3,2].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[3,2].allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real mfr_2[3,2].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if mfr_2[3,2].allowFlowReversal then 1e+060 else 0.0);
...
//   Real mfr_2[3,3].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[3,3].allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real mfr_2[3,3].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if mfr_2[3,3].allowFlowReversal then 1e+060 else 0.0);
...
//   Real mfr_2[3,4].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[3,4].allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real mfr_2[3,4].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if mfr_2[3,4].allowFlowReversal then 1e+060 else 0.0);
...
//   Real ducFixRes_2.port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if ducFixRes_2.allowFlowReversal then -1e+060 else 0.0, max = 100000.0, start = ducFixRes_2.mStart_flow_a);
...
//   Real ducFixRes_2.port_b[1,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
...
//   Real ducFixRes_2.port_b[1,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
...
//   Real ducFixRes_2.port_b[1,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
...
//   Real ducFixRes_2.port_b[1,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
...
//   Real ducFixRes_2.port_b[2,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
...
//   Real ducFixRes_2.port_b[2,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
...
//   Real ducFixRes_2.port_b[2,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
...
//   Real ducFixRes_2.port_b[2,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
...
//   Real ducFixRes_2.port_b[3,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
...
//   Real ducFixRes_2.port_b[3,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
...
//   Real ducFixRes_2.port_b[3,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
...
//   Real ducFixRes_2.port_b[3,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
...
//   Real ducFixRes_2.fixRes.port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if ducFixRes_2.fixRes.allowFlowReversal then -1e+060 else 0.0, max = 100000.0);
...
//   Real ducFixRes_2.fixRes.port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.fixRes.allowFlowReversal then 1e+060 else 0.0);
...
//   protected final parameter Boolean ducFixRes_2.fixRes.computeFlowResistance = ducFixRes_2.fixRes.dp_nominal_pos > 1e-015;
...
//   protected Real ducFixRes_2.floDis.port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if ducFixRes_2.floDis.allowFlowReversal then -1e+060 else 0.0, max = 100000.0, start = ducFixRes_2.floDis.mStart_flow_a);
...
//   protected Real ducFixRes_2.floDis.port_b[1,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.floDis.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
...
//   protected Real ducFixRes_2.floDis.port_b[1,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.floDis.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
...
//   protected Real ducFixRes_2.floDis.port_b[1,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.floDis.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
...
//   protected Real ducFixRes_2.floDis.port_b[1,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.floDis.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
...
//   protected Real ducFixRes_2.floDis.port_b[2,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.floDis.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
...
//   protected Real ducFixRes_2.floDis.port_b[2,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.floDis.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
...
//   protected Real ducFixRes_2.floDis.port_b[2,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.floDis.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
...
//   protected Real ducFixRes_2.floDis.port_b[2,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.floDis.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
...
//   protected Real ducFixRes_2.floDis.port_b[3,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.floDis.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
...
//   protected Real ducFixRes_2.floDis.port_b[3,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.floDis.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
...
//   protected Real ducFixRes_2.floDis.port_b[3,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.floDis.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
...
//   protected Real ducFixRes_2.floDis.port_b[3,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducFixRes_2.floDis.allowFlowReversal then 1e+060 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
...
//   Real ducNoRes_2.port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if ducNoRes_2.allowFlowReversal then -1e+060 else 0.0, max = 100000.0, start = ducNoRes_2.mStart_flow_a);
...
//   Real ducNoRes_2.port_b[1,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducNoRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
...
//   Real ducNoRes_2.port_b[1,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducNoRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
...
//   Real ducNoRes_2.port_b[1,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducNoRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
...
//   Real ducNoRes_2.port_b[1,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducNoRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
...
//   Real ducNoRes_2.port_b[2,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducNoRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
...
//   Real ducNoRes_2.port_b[2,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducNoRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
...
//   Real ducNoRes_2.port_b[2,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducNoRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
...
//   Real ducNoRes_2.port_b[2,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducNoRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
...
//   Real ducNoRes_2.port_b[3,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducNoRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
...
//   Real ducNoRes_2.port_b[3,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducNoRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
...
//   Real ducNoRes_2.port_b[3,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducNoRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
...
//   Real ducNoRes_2.port_b[3,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -100000.0, max = if ducNoRes_2.allowFlowReversal then 1e+060 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
...
//   Real hea1.port_a[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if hea1.allowFlowReversal then -1e+060 else 0.0, max = 100000.0, start = hea1.mStart_flow_a / /*Real*/(hea1.nPipPar));
...
//   Real hea1.port_a[2].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if hea1.allowFlowReversal then -1e+060 else 0.0, max = 100000.0, start = hea1.mStart_flow_a / /*Real*/(hea1.nPipPar));
...
//   Real hea1.port_a[3].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if hea1.allowFlowReversal then -1e+060 else 0.0, max = 100000.0, start = hea1.mStart_flow_a / /*Real*/(hea1.nPipPar));
...
//   Real hea1.port_b[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if hea1.allowFlowReversal then 1e+060 else 0.0, start = (-hea1.mStart_flow_a) / /*Real*/(hea1.nPipPar));
...
//   Real hea1.port_b[2].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if hea1.allowFlowReversal then 1e+060 else 0.0, start = (-hea1.mStart_flow_a) / /*Real*/(hea1.nPipPar));
...
//   Real hea1.port_b[3].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if hea1.allowFlowReversal then 1e+060 else 0.0, start = (-hea1.mStart_flow_a) / /*Real*/(hea1.nPipPar));
...
//   Real hea2.port_a[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if hea2.allowFlowReversal then -1e+060 else 0.0, max = 100000.0, start = hea2.mStart_flow_a / /*Real*/(hea2.nPipPar));
...
//   Real hea2.port_a[2].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if hea2.allowFlowReversal then -1e+060 else 0.0, max = 100000.0, start = hea2.mStart_flow_a / /*Real*/(hea2.nPipPar));
...
//   Real hea2.port_a[3].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if hea2.allowFlowReversal then -1e+060 else 0.0, max = 100000.0, start = hea2.mStart_flow_a / /*Real*/(hea2.nPipPar));
...
//   Real hea2.port_b[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if hea2.allowFlowReversal then 1e+060 else 0.0, start = (-hea2.mStart_flow_a) / /*Real*/(hea2.nPipPar));
...
//   Real hea2.port_b[2].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if hea2.allowFlowReversal then 1e+060 else 0.0, start = (-hea2.mStart_flow_a) / /*Real*/(hea2.nPipPar));
...
//   Real hea2.port_b[3].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -100000.0, max = if hea2.allowFlowReversal then 1e+060 else 0.0, start = (-hea2.mStart_flow_a) / /*Real*/(hea2.nPipPar));
...
//   Real sou_2.ports[1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if sou_2.flowDirection == Modelica.Fluid.Types.PortFlowDirection.Entering then 0.0 else -1e+060, max = if sou_2.flowDirection == Modelica.Fluid.Types.PortFlowDirection.Leaving then 0.0 else 1e+060);
...
//   Real sin_2.ports[1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if sin_2.flowDirection == Modelica.Fluid.Types.PortFlowDirection.Entering then 0.0 else -1e+060, max = if sin_2.flowDirection == Modelica.Fluid.Types.PortFlowDirection.Leaving then 0.0 else 1e+060);
...
//   sou_2.medium.X_sat = min(0.6219647130774989 * sou_2.medium.p_steam_sat * (1.0 - sou_2.medium.Xi[1]) / max(1e-013, sou_2.medium.p - sou_2.medium.p_steam_sat), 1.0);
...
//   sou_2.medium.x_sat = 0.6219647130774989 * sou_2.medium.p_steam_sat / max(1e-013, sou_2.medium.p - sou_2.medium.p_steam_sat);
//   sou_2.medium.x_water = sou_2.medium.Xi[1] / max(sou_2.medium.X_air, 1e-013);
...
//   sin_2.medium.X_sat = min(0.6219647130774989 * sin_2.medium.p_steam_sat * (1.0 - sin_2.medium.Xi[1]) / max(1e-013, sin_2.medium.p - sin_2.medium.p_steam_sat), 1.0);
...
//   sin_2.medium.x_sat = 0.6219647130774989 * sin_2.medium.p_steam_sat / max(1e-013, sin_2.medium.p - sin_2.medium.p_steam_sat);
//   sin_2.medium.x_water = sin_2.medium.Xi[1] / max(sin_2.medium.X_air, 1e-013);
...
//   ducNoRes_2.port_b[1,1].Xi_outflow[1] = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.Xi_outflow[1] + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.Xi_outflow[1]) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[1,2].Xi_outflow[1] = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.Xi_outflow[1] + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.Xi_outflow[1]) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[1,3].Xi_outflow[1] = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.Xi_outflow[1] + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.Xi_outflow[1]) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[1,4].Xi_outflow[1] = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.Xi_outflow[1] + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.Xi_outflow[1]) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[2,1].Xi_outflow[1] = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.Xi_outflow[1] + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.Xi_outflow[1]) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[2,2].Xi_outflow[1] = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.Xi_outflow[1] + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.Xi_outflow[1]) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[2,3].Xi_outflow[1] = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.Xi_outflow[1] + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.Xi_outflow[1]) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[2,4].Xi_outflow[1] = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.Xi_outflow[1] + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.Xi_outflow[1]) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[3,1].Xi_outflow[1] = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.Xi_outflow[1] + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.Xi_outflow[1]) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[3,2].Xi_outflow[1] = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.Xi_outflow[1] + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.Xi_outflow[1]) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[3,3].Xi_outflow[1] = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.Xi_outflow[1] + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.Xi_outflow[1]) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[3,4].Xi_outflow[1] = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.Xi_outflow[1] + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.Xi_outflow[1]) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_a.Xi_outflow[1] = (max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.Xi_outflow[1] + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.Xi_outflow[1]) / (max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[1,1].h_outflow = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.h_outflow + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.h_outflow + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.h_outflow + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.h_outflow + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.h_outflow + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.h_outflow + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.h_outflow + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.h_outflow + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.h_outflow + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.h_outflow + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.h_outflow + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.h_outflow) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[1,2].h_outflow = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.h_outflow + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.h_outflow + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.h_outflow + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.h_outflow + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.h_outflow + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.h_outflow + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.h_outflow + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.h_outflow + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.h_outflow + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.h_outflow + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.h_outflow + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.h_outflow) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[1,3].h_outflow = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.h_outflow + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.h_outflow + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.h_outflow + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.h_outflow + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.h_outflow + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.h_outflow + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.h_outflow + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.h_outflow + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.h_outflow + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.h_outflow + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.h_outflow + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.h_outflow) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[1,4].h_outflow = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.h_outflow + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.h_outflow + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.h_outflow + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.h_outflow + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.h_outflow + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.h_outflow + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.h_outflow + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.h_outflow + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.h_outflow + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.h_outflow + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.h_outflow + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.h_outflow) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[2,1].h_outflow = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.h_outflow + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.h_outflow + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.h_outflow + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.h_outflow + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.h_outflow + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.h_outflow + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.h_outflow + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.h_outflow + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.h_outflow + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.h_outflow + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.h_outflow + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.h_outflow) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[2,2].h_outflow = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.h_outflow + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.h_outflow + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.h_outflow + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.h_outflow + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.h_outflow + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.h_outflow + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.h_outflow + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.h_outflow + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.h_outflow + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.h_outflow + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.h_outflow + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.h_outflow) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[2,3].h_outflow = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.h_outflow + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.h_outflow + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.h_outflow + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.h_outflow + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.h_outflow + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.h_outflow + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.h_outflow + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.h_outflow + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.h_outflow + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.h_outflow + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.h_outflow + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.h_outflow) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[2,4].h_outflow = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.h_outflow + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.h_outflow + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.h_outflow + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.h_outflow + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.h_outflow + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.h_outflow + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.h_outflow + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.h_outflow + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.h_outflow + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.h_outflow + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.h_outflow + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.h_outflow) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[3,1].h_outflow = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.h_outflow + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.h_outflow + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.h_outflow + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.h_outflow + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.h_outflow + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.h_outflow + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.h_outflow + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.h_outflow + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.h_outflow + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.h_outflow + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.h_outflow + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.h_outflow) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[3,2].h_outflow = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.h_outflow + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.h_outflow + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.h_outflow + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.h_outflow + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.h_outflow + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.h_outflow + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.h_outflow + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.h_outflow + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.h_outflow + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.h_outflow + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.h_outflow + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.h_outflow) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[3,3].h_outflow = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.h_outflow + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.h_outflow + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.h_outflow + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.h_outflow + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.h_outflow + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.h_outflow + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.h_outflow + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.h_outflow + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.h_outflow + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.h_outflow + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.h_outflow + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.h_outflow) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_b[3,4].h_outflow = (max(ducNoRes_2.port_a.m_flow, 1e-07) * res_2.port_a.h_outflow + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.h_outflow + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.h_outflow + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.h_outflow + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.h_outflow + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.h_outflow + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.h_outflow + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.h_outflow + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.h_outflow + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.h_outflow + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.h_outflow + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.h_outflow) / (max(ducNoRes_2.port_a.m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
//   ducNoRes_2.port_a.h_outflow = (max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) * mfr_2[3,4].port_b.h_outflow + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) * mfr_2[3,3].port_b.h_outflow + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) * mfr_2[3,2].port_b.h_outflow + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) * mfr_2[3,1].port_b.h_outflow + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) * mfr_2[2,4].port_b.h_outflow + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) * mfr_2[2,3].port_b.h_outflow + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) * mfr_2[2,2].port_b.h_outflow + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) * mfr_2[2,1].port_b.h_outflow + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) * mfr_2[1,4].port_b.h_outflow + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) * mfr_2[1,3].port_b.h_outflow + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) * mfr_2[1,2].port_b.h_outflow + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07) * mfr_2[1,1].port_b.h_outflow) / (max(ducNoRes_2.port_b[3,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[3,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[2,1].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,4].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,3].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,2].m_flow, 1e-07) + max(ducNoRes_2.port_b[1,1].m_flow, 1e-07)) " equation generated by stream handling";
